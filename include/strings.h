...
extern const u8 gBirchDexRatingText_LessThan201[];
extern const u8 gBirchDexRatingText_LessThan301[];
...
[span="background-color:green"]extern const u8 gMenuText_Move[];
