...
static const struct WindowTemplate sItemGiveTakeWindowTemplate =
{
    .bg = 2,
    .tilemapLeft = 23,
    [span="background-color:red"].timemapTop = 13,[/span]
    [span="background-color:green"].tilemapTop = 11,[/span]
    .width = 6,
    [span="background-color:red"].height = 6,[/span]
    [span="background-color:green"].height = 8,[/span]
    .paletteNum = 14,
    .baseBlock = 0x39D,
};
...
static const u8 *const sActionStringTable[] =
{
    ...
    [span="background-color:green"][PARTY_MSG_MOVE_ITEM_WHERE]        = gText_MoveItemWhere,[/span]
};
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [span="background-color:green"][MENU_MOVE_ITEM] = {gMenuText_Move, CursorCb_MoveItem},[/span]
...
[span="background-color:red"]static const u8 sPartyMenuAction_GiveTakeItemCancel[] = {MENU_GIVE, MENU_TAKE_ITEM, MENU_CANCEL2};[/span]
[span="background-color:green"]static const u8 sPartyMenuAction_GiveTakeItemCancel[] = {MENU_GIVE, MENU_TAKE_ITEM, MENU_MOVE_ITEM, MENU_CANCEL2};[/span]
