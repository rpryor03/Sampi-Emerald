...
static const struct FrontierBrainMon sFrontierBrainsMons[][2][FRONTIER_PARTY_SIZE] =
{
    [FRONTIER_FACILITY_TOWER] =
    {
        ...
        // Gold Symbol.
        {
            ...
            },
            {
                ...
                .evs = {0, 0, 0, 252, 252, 4)},
                .moves = {MOVE_LUSTER_PURGE, MOVE_AURA_SPHERE, MOVE_ROOST, MOVE_DRACO_METEOR},
            },
        },
    },
        ...
        {
            {
                ...
                .fixedIV = MAX_PER_STAT_IVS,
                .evs = {252, 16, 28, 16, 0, 196},
                .nature = NATURE_ADAMANT,
                .moves = {MOVE_OUTRAGE, MOVE_POISON_JAB, MOVE_SCALE_SHOT, MOVE_EARTHQUAKE},
            },
            {
    ...
    [FRONTIER_FACILITY_PYRAMID] =
    {
        ...
        {
            {
                .species = species = SPECIES_REGIROCK,
                .heldItem = ITEM_LEFTOVERS,
                .ability = ABILITY_CLEAR_BODY,
                .fixedIV = MAX_PER_STAT_IVS,
